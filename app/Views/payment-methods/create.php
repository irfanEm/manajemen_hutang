...
<div class="container">
  <div class="form-container">
    ...
    <form action="/payment-methods/store" method="post">
      <?= csrf_field() ?>

      <div class="mb-3">
        <label for="kode_metode" class="form-label">Kode Metode Pembayaran</label>
        <input type="text" class="form-control" id="kode_metode" name="kode_metode" placeholder="Contoh: PM001" required>
      </div>
      
      <div class="mb-3">
        <label for="nama_metode" class="form-label">Nama Metode Pembayaran</label>
        <input type="text" class="form-control" id="nama_metode" name="nama_metode" placeholder="Contoh: Transfer Bank / QRIS" required>
      </div>

      <div class="action-buttons">
        <a href="/payment-methods" class="btn-custom btn-back">
