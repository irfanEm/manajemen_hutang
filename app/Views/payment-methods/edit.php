...
<div class="container">
  <div class="form-container">
    <h2 class="form-title">✏️ Edit Metode Pembayaran</h2>

    <form action="/payment-methods/update/<?= $method['id'] ?>" method="post">
      <?= csrf_field() ?>
      <input type="hidden" name="_method" value="PUT">

      <div class="mb-3">
        <label for="nama_metode" class="form-label">Nama Metode Pembayaran</label>
        <input type="text" class="form-control" id="nama_metode" name="nama_metode" value="<?= esc($method['nama_metode']) ?>" required>
      </div>
